...
| `R/merge.R` | Merges chromosome-split Step2 output files into all-chromosome per-feature files. |
...
| `extdata/step_merge.R` | Merges chromosome-level outputs into per-feature all-chromosome files. |
...
| `simulation/run/` | Slurm scripts for Step0, Step1, Step2.1, Step2.2, merge, Step3, and Step4 on an HPC cluster. |
